...
contract StafiDistributer is StafiBase, IStafiEtherWithdrawer {
    ...
    function receiveEtherWithdrawal() override external payable onlyLatestContract("stafiDistributer", address(this)) onlyLatestContract("stafiEther", msg.sender) {}
    
    function distributeFee(uint256 amount) external payable onlyLatestContract("stafiDistributer", address(this)) {
        ...
        if (usersFee > 0) {
            stafiUserDeposit.recycleDistributerDeposit{value: usersFee}();
        }
